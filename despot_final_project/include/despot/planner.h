...
public:
	 ...
	 */
	virtual bool RunStep(Solver* solver, World* world, Logger* logger, int different_time);
	 ...
	 */
	virtual void PlanningLoop(Solver*& solver, World* world, Logger* logger, string solver_type);
